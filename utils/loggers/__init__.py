...
class Loggers():
    ...
    def on_train_batch_end(self, model, ni, imgs, imgs_A, targets, paths, vals):
        ...
        if self.plots:
            if ni < 3:
                ...
                f_A = self.save_dir / f'train_batch{ni}_A.jpg'  # filename
                plot_images(imgs, targets, paths, f)
                plot_images(imgs_A, targets, paths, f_A)
